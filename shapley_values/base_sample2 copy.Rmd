...
encuesta_salud_train_gender_numeric$genero = as.factor(encuesta_salud_train_gender_numeric$genero)
encuesta_salud_train_gender_numeric$genero = as.numeric(encuesta_salud_train_gender_numeric$genero)
as.numeric(as.character(encuesta_salud_train_gender_numeric$genero))
x_var <- c( "edad","genero","altura","dias_consumo_comida_rapida","consumo_diario_alcohol")
y_var <- "peso"
sapply(encuesta_salud_train_gender_numeric, class)                           # Get classes of all columns
...
data_x$genero <- as.numeric(data_x$genero)  # Convert one variable to numeric
